...
<div class="pointer-events-auto h-full w-full px-8 pt-8">
  <div
    class="pointer-events-auto flex h-full flex-col gap-2 overflow-y-auto border-b border-stone-500 horizontal:border-0"
  >
