...
>
	...
	{#snippet about()}
		<div class="flex flex-col">
			{#if app.state === 'idle'}
				<p>
					It's a todo app. Nothing fancy or original. Perheaps seeing todo's as quests helps finding
					the determination to complete them. When you aren't logged in, your data do persist in
					your local storage. Under the hood, there's some <b>react</b> involved.
				</p>
			{:else}
